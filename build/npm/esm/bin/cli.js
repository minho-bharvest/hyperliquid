...
import { extractArgs, transformArgs } from "./_utils.js";
import { ExchangeClient, HttpTransport, InfoClient } from "../src/mod.js";
import { PrivateKeySigner } from "../src/signing/mod.js";
// ============================================================
// Execute
// ============================================================
...
async function executeEndpointMethod(endpoint, method, args) {
    ...
    switch (endpoint) {
        case "info":
            ...
            break;
        case "exchange": {
            const wallet = new PrivateKeySigner(args["private-key"]);

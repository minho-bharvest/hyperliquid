...
export declare const RegisterReferrerRequest: v.SchemaWithPipe<readonly [v.ObjectSchema<{
    ...
    readonly action: v.SchemaWithPipe<readonly [v.ObjectSchema<{
        ...
        readonly code: v.SchemaWithPipe<readonly [v.StringSchema<undefined>, v.MinLengthAction<string, 1, undefined>, v.MaxLengthAction<string, 20, undefined>, v.DescriptionAction<string, "Referral code to create.">]>;
...
export declare const RegisterReferrerResponse: v.SchemaWithPipe<readonly [v.UnionSchema<[v.SchemaWithPipe<readonly [v.ObjectSchema<{

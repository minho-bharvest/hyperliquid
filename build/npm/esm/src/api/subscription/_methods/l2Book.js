...
// API Schemas
// ============================================================
import { Integer, UnsignedDecimal, UnsignedInteger } from "../../_schemas.js";
...
export const L2BookRequest = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        nSigFigs: v.pipe(v.nullish(v.pipe(Integer, v.picklist([2, 3, 4, 5]))), v.description("Number of significant figures.")),
        /** Mantissa for aggregation (if `nSigFigs` is 5). */
        mantissa: v.pipe(v.nullish(v.pipe(Integer, v.picklist([2, 5]))), v.description("Mantissa for aggregation (if `nSigFigs` is 5).")),

...
import { SpotClearinghouseStateResponse } from "../../info/_methods/spotClearinghouseState.js";
...
export const SpotStateEvent = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        spotState: v.pipe(SpotClearinghouseStateResponse, v.description("Account summary for spot trading.")),

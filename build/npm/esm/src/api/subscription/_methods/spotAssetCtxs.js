...
// API Schemas
// ============================================================
import { SpotAssetCtxSchema } from "../../info/_methods/_base/commonSchemas.js";
...
export const SpotAssetCtxsEvent = /* @__PURE__ */ (() => {
    return v.pipe(v.array(SpotAssetCtxSchema), v.description("Event of spot asset contexts."));
})();
/**

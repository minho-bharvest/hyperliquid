...
import { FrontendOpenOrdersResponse } from "../../info/_methods/frontendOpenOrders.js";
...
export const OpenOrdersEvent = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        orders: v.pipe(FrontendOpenOrdersResponse, v.description("Array of open orders with additional display information.")),

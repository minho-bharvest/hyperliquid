...
// API Schemas
// ============================================================
import { RecentTradesResponse } from "../../info/_methods/recentTrades.js";
...
export const TradesEvent = /* @__PURE__ */ (() => {
    return v.pipe(RecentTradesResponse, v.description("Event of array of trades for a specific asset."));
})();
/**

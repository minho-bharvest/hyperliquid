...
import { HistoricalOrdersResponse } from "../../info/_methods/historicalOrders.js";
...
export const UserHistoricalOrdersEvent = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        orderHistory: v.pipe(HistoricalOrdersResponse, v.description("Array of frontend orders with current processing status.")),

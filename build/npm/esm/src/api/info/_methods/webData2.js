...
import { PerpAssetCtxSchema, SpotAssetCtxSchema, TwapStateSchema } from "./_base/commonSchemas.js";
...
export const WebData2Response = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        clearinghouseState: v.pipe(ClearinghouseStateResponse, v.description("Account summary for perpetual trading.")),
        /** Array of leading vaults for a user. */
        leadingVaults: v.pipe(LeadingVaultsResponse, v.description("Array of leading vaults for a user.")),
        ...
        openOrders: v.pipe(FrontendOpenOrdersResponse, v.description("Array of open orders with additional display information.")),
        ...
        meta: v.pipe(MetaResponse, v.description("Metadata for perpetual assets.")),
        /** Array of contexts for each perpetual asset. */
        assetCtxs: v.pipe(v.array(PerpAssetCtxSchema), v.description("Array of contexts for each perpetual asset.")),
        ...
        twapStates: v.pipe(v.array(v.tuple([UnsignedInteger, TwapStateSchema])), v.description("Array of tuples containing TWAP order ID and its state.")),
        /** Account summary for spot trading. */
        spotState: v.pipe(v.optional(SpotClearinghouseStateResponse), v.description("Account summary for spot trading.")),
        /** Asset context for each spot asset. */
        spotAssetCtxs: v.pipe(v.array(SpotAssetCtxSchema), v.description("Asset context for each spot asset.")),

...
export const DelegatorSummaryResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        delegated: v.pipe(UnsignedDecimal, v.description("Total amount of delegated tokens.")),
        /** Total amount of undelegated tokens. */
        undelegated: v.pipe(UnsignedDecimal, v.description("Total amount of undelegated tokens.")),
        /** Total amount of tokens pending withdrawal. */
        totalPendingWithdrawal: v.pipe(UnsignedDecimal, v.description("Total amount of tokens pending withdrawal.")),
        /** Number of pending withdrawals. */
        nPendingWithdrawals: v.pipe(UnsignedInteger, v.description("Number of pending withdrawals.")),

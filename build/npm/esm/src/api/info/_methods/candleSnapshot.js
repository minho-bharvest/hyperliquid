...
export const CandleSnapshotResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.array(v.object({
        ...
        t: v.pipe(UnsignedInteger, v.description("Opening timestamp (ms since epoch).")),
        /** Closing timestamp (ms since epoch). */
        T: v.pipe(UnsignedInteger, v.description("Closing timestamp (ms since epoch).")),
        /** Asset symbol. */
        ...
        /** Opening price. */
        o: v.pipe(UnsignedDecimal, v.description("Opening price.")),
        /** Closing price. */
        c: v.pipe(UnsignedDecimal, v.description("Closing price.")),
        /** Highest price. */
        h: v.pipe(UnsignedDecimal, v.description("Highest price.")),
        /** Lowest price. */
        l: v.pipe(UnsignedDecimal, v.description("Lowest price.")),
        /** Total volume traded in base currency. */
        v: v.pipe(UnsignedDecimal, v.description("Total volume traded in base currency.")),
        /** Number of trades executed. */
        n: v.pipe(UnsignedInteger, v.description("Number of trades executed.")),

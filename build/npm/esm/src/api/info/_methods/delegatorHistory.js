...
export const DelegatorHistoryResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.array(v.object({
        ...
        time: v.pipe(UnsignedInteger, v.description("Timestamp of the delegation event (in ms since epoch).")),
        /** Transaction hash of the delegation event. */
        hash: v.pipe(Hex, v.length(66), v.description("Transaction hash of the delegation event.")),
        ...
        delta: v.pipe(v.union([
            v.object({
                ...
                delegate: v.pipe(v.object({
                    ...
                    validator: v.pipe(Address, v.description("Address of the validator receiving or losing delegation.")),
                    /** Amount of tokens being delegated or undelegated. */
                    amount: v.pipe(UnsignedDecimal, v.description("Amount of tokens being delegated or undelegated.")),
            ...
            v.object({
                ...
                cDeposit: v.pipe(v.object({
                    ...
                    amount: v.pipe(UnsignedDecimal, v.description("Amount of tokens being deposited.")),
            ...
            v.object({
                ...
                withdrawal: v.pipe(v.object({
                    ...
                    amount: v.pipe(UnsignedDecimal, v.description("Amount of tokens being withdrawn.")),

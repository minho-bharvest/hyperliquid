...
export const MarginTableResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        marginTiers: v.pipe(v.array(v.object({
            ...
            lowerBound: v.pipe(UnsignedDecimal, v.description("Lower position size boundary for this tier.")),
            /** Maximum allowed leverage for this tier. */
            maxLeverage: v.pipe(UnsignedInteger, v.minValue(1), v.description("Maximum allowed leverage for this tier.")),

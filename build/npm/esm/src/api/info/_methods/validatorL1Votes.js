...
// API Schemas
// ============================================================
import { Address, Integer } from "../../_schemas.js";
/**
...
export const ValidatorL1VotesResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.array(v.object({
        ...
        expireTime: v.pipe(Integer, v.description("Timestamp when the vote expires (in ms since epoch).")),
        /** Type of the vote. */
        ...
        votes: v.pipe(v.array(Address), v.description("List of validator addresses that cast this vote.")),
 ...
 * ```
 */
export function validatorL1Votes(config, paramsOrSignal, maybeSignal) {

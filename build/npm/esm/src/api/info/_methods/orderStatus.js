...
import { FrontendOpenOrderSchema, OrderProcessingStatusSchema } from "./_base/commonSchemas.js";
/**
...
export const OrderStatusRequest = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        oid: v.pipe(v.union([UnsignedInteger, Cloid]), v.description("Order ID or Client Order ID.")),
    ...
    return v.pipe(v.variant("status", [
        v.object({
            ...
            order: v.pipe(v.object({
                ...
                order: v.pipe(FrontendOpenOrderSchema, v.description("Open order with additional display information.")),
                /**
                 ...
                 */
                status: v.pipe(OrderProcessingStatusSchema, v.description("Order processing status." +
                    '\n- `"open"`: Order active and waiting to be filled.' +
                    '\n- `"filled"`: Order fully executed.' +
                    '\n- `"canceled"`: Order canceled by the user.' +
                    '\n- `"triggered"`: Order triggered and awaiting execution.' +
                ...
                statusTimestamp: v.pipe(UnsignedInteger, v.description("Timestamp when the status was last updated (in ms since epoch).")),

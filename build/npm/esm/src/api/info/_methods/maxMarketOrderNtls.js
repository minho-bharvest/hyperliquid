...
export const MaxMarketOrderNtlsResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.array(v.tuple([UnsignedDecimal, v.string()])), v.description("Array of tuples containing maximum market order notionals and their corresponding asset symbols."));
})();
/**
 * Request maximum market order notionals.
 *
 ...
 * ```
 */
export function maxMarketOrderNtls(config, paramsOrSignal, maybeSignal) {

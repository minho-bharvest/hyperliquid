...
export const UserNonFundingLedgerUpdatesRequest = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        startTime: v.pipe(v.optional(UnsignedInteger), v.description("Start time (in ms since epoch).")),
...
export const UserNonFundingLedgerUpdatesResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.array(v.object({
        ...
        /** L1 transaction hash. */
        hash: v.pipe(Hex, v.length(66), v.description("L1 transaction hash.")),
        /** Update details. */
        delta: v.pipe(v.variant("type", [
            ...
            v.object({
                ...
                usdc: v.pipe(UnsignedDecimal, v.description("Amount transferred in USDC.")),
            ...
            v.object({
                ...
                usdc: v.pipe(UnsignedDecimal, v.description("Amount transferred in USDC.")),
                /** Initiator address. */
                user: v.pipe(Address, v.description("Initiator address.")),
                /** Destination address. */
            ...
            v.object({
                ...
                liquidatedNtlPos: v.pipe(UnsignedDecimal, v.description("Total notional value of liquidated positions.")),
                /** Account value at liquidation time. */
                accountValue: v.pipe(UnsignedDecimal, v.description("Account value at liquidation time.")),
            ...
            v.object({
                ...
                amount: v.pipe(UnsignedDecimal, v.description("Amount of rewards claimed.")),
                /** Token symbol. */
            ...
            v.object({
                ...
                token: v.pipe(v.string(), v.description("Token symbol.")),
                /** Amount transferred. */
                amount: v.pipe(UnsignedDecimal, v.description("Amount transferred.")),
                /** Equivalent USDC value. */
                usdcValue: v.pipe(UnsignedDecimal, v.description("Equivalent USDC value.")),
                /** Initiator address. */
                user: v.pipe(Address, v.description("Initiator address.")),
                /** Destination address. */
                destination: v.pipe(Address, v.description("Destination address.")),
                ...
                fee: v.pipe(UnsignedDecimal, v.description("Transfer fee.")),
                /** Fee in native token. */
                nativeTokenFee: v.pipe(UnsignedDecimal, v.description("Fee in native token.")),
                /** Nonce of the transfer. */
                nonce: v.pipe(v.nullable(UnsignedInteger), v.description("Nonce of the transfer.")),
            ...
            v.object({
                ...
                vault: v.pipe(Address, v.description("Address of the created vault.")),
                /** Initial allocated amount in USDC. */
                usdc: v.pipe(UnsignedDecimal, v.description("Initial allocated amount in USDC.")),
                /** Vault creation fee. */
            ...
            v.object({
                ...
                vault: v.pipe(Address, v.description("Address of the target vault.")),
                /** Amount deposited in USDC. */
                usdc: v.pipe(UnsignedDecimal, v.description("Amount deposited in USDC.")),
            }),
            ...
            v.object({
                ...
                vault: v.pipe(Address, v.description("Address of the vault distributing funds.")),
            ...
            v.object({
                ...
                /** Vault address. */
                vault: v.pipe(Address, v.description("Vault address.")),
                /** Address of the user withdrawing funds. */
                user: v.pipe(Address, v.description("Address of the user withdrawing funds.")),
                /** Withdrawal request amount in USD. */
                requestedUsd: v.pipe(UnsignedDecimal, v.description("Withdrawal request amount in USD.")),
                /** Withdrawal commission fee. */
                commission: v.pipe(UnsignedDecimal, v.description("Withdrawal commission fee.")),
                /** Closing cost associated with positions. */
                closingCost: v.pipe(UnsignedDecimal, v.description("Closing cost associated with positions.")),
                /** Basis value for withdrawal calculation. */
                basis: v.pipe(UnsignedDecimal, v.description("Basis value for withdrawal calculation.")),
            ...
            v.object({
                ...
                user: v.pipe(Address, v.description("Address of the sender.")),
                /** Destination address. */
                destination: v.pipe(Address, v.description("Destination address.")),
                ...
                nativeTokenFee: v.pipe(UnsignedDecimal, v.description("Fee in native token.")),
                /** Nonce of the transfer. */
                nonce: v.pipe(UnsignedInteger, v.description("Nonce of the transfer.")),
                /** Token in which the fee is denominated (e.g., "USDC"). */
                feeToken: v.pipe(v.string(), v.description('Token in which the fee is denominated (e.g., "USDC").')),
            }),
            ...
            v.object({
                ...
                amount: v.pipe(UnsignedDecimal, v.description("Amount in the specified token.")),
            }),

...
export const ReferralResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.object({
        ...
        referredBy: v.pipe(v.nullable(v.object({
            /** Referrer address. */
            referrer: v.pipe(Address, v.description("Referrer address.")),
            /** Referral code used. */
        ...
        unclaimedRewards: v.pipe(UnsignedDecimal, v.description("Rewards earned but not yet claimed.")),
        /** Rewards that have been claimed. */
        claimedRewards: v.pipe(UnsignedDecimal, v.description("Rewards that have been claimed.")),
            ...
            v.object({
                ...
                data: v.pipe(v.object({
                    ...
                    referralStates: v.pipe(v.array(v.object({
                        ...
                        cumRewardedFeesSinceReferred: v.pipe(UnsignedDecimal, v.description("Total fees rewarded to the referred user since referral.")),
                        ...
                        user: v.pipe(Address, v.description("Address of the referred user.")),
        ...
        rewardHistory: v.pipe(v.array(v.object({
            ...
            vlm: v.pipe(UnsignedDecimal, v.description("Traded volume at the time of reward.")),

...
export const FundingHistoryResponse = /* @__PURE__ */ (() => {
    return v.pipe(v.array(v.object({
        ...
        /** Funding rate. */
        fundingRate: v.pipe(Decimal, v.description("Funding rate.")),
        /** Premium price. */
        premium: v.pipe(Decimal, v.description("Premium price.")),
        /** Funding record timestamp (ms since epoch). */
        time: v.pipe(UnsignedInteger, v.description("Funding record timestamp (ms since epoch).")),

...
exports.TokenDelegateTypes = exports.TokenDelegateResponse = exports.TokenDelegateRequest = void 0;
...
exports.TokenDelegateRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            wei: v.pipe(_schemas_js_1.UnsignedInteger, v.minValue(1), v.description("Amount for delegate/undelegate (float * 1e8).")),

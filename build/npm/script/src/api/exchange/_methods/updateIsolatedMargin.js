...
exports.UpdateIsolatedMarginResponse = exports.UpdateIsolatedMarginRequest = void 0;
...
exports.UpdateIsolatedMarginRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            ntli: v.pipe(_schemas_js_1.Integer, v.description("Amount to adjust (float * 1e6).")),
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/exchange-endpoint#update-isolated-margin
 */
exports.UpdateIsolatedMarginResponse = (() => {

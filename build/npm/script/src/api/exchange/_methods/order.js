...
exports.OrderResponse = exports.OrderRequest = void 0;
exports.order = order;
    ...
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            builder: v.pipe(v.optional(v.object({
                /** Builder address. */
                b: v.pipe(_schemas_js_1.Address, v.description("Builder address.")),
                /** Builder fee in 0.1bps (1 = 0.0001%). Max 100 for perps (0.1%), 1000 for spot (1%). */
                f: v.pipe(_schemas_js_1.UnsignedInteger, v.maxValue(1000), v.description("Builder fee in 0.1bps (1 = 0.0001%). Max 100 for perps (0.1%), 1000 for spot (1%).")),
                ...
                statuses: v.pipe(v.array(v.union([
                    ...
                    v.object({
                        ...
                        filled: v.pipe(v.object({
                            /** Total size filled. */
                            totalSz: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Total size filled.")),
                            /** Average price of fill. */
                            avgPx: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Average price of fill.")),
                            /** Order ID. */
                            oid: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Order ID.")),
                            /** Client Order ID. */
                            cloid: v.pipe(v.optional(_schemas_js_1.Cloid), v.description("Client Order ID.")),

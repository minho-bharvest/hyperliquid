...
exports.VaultTransferResponse = exports.VaultTransferRequest = void 0;
...
exports.VaultTransferRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            usd: v.pipe(_schemas_js_1.UnsignedInteger, v.minValue(1), v.description("Amount for deposit/withdrawal (float * 1e6).")),

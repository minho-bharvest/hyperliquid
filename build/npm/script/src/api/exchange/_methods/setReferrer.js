...
exports.SetReferrerResponse = exports.SetReferrerRequest = void 0;
...
exports.SetReferrerRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            /** Referral code. */
            code: v.pipe(v.string(), v.minLength(1), v.maxLength(20), v.description("Referral code.")),

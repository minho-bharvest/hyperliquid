...
exports.VaultDistributeResponse = exports.VaultDistributeRequest = void 0;
...
exports.VaultDistributeRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
             ...
             */
            usd: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Amount to distribute (float * 1e6)." +
                "\nSet to 0 to close the vault.")),
...
exports.VaultDistributeResponse = (() => {

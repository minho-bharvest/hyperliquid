...
exports.PerpDeployResponse = exports.PerpDeployRequest = void 0;
        ...
        action: v.pipe(v.union([
            v.object({
                ...
                registerAsset2: v.pipe(v.object({
                    ...
                    maxGas: v.pipe(v.nullable(_schemas_js_1.UnsignedInteger), v.description("Max gas in native token wei. If not provided, then uses current deploy auction price.")),
                    ...
                    assetRequest: v.pipe(v.object({
                        ...
                        szDecimals: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Number of decimal places for size.")),
                        /** Initial oracle price for the asset. */
                        oraclePx: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Initial oracle price for the asset.")),
                        /** Margin table identifier for risk management. */
                        marginTableId: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Margin table identifier for risk management.")),
                    ...
                    schema: v.pipe(v.nullable(v.object({
                        ...
                        oracleUpdater: v.pipe(v.nullable(_schemas_js_1.Address), v.description("User to update oracles. If not provided, then deployer is assumed to be oracle updater.")),
            ...
            v.object({
                ...
                setOracle: v.pipe(v.object({
                    ...
                    oraclePxs: v.pipe(v.array(v.tuple([
                        v.string(),
                    ...
                    markPxs: v.pipe(v.array(v.array(v.tuple([
                        v.string(),
                        _schemas_js_1.UnsignedDecimal,
                    ]))), v.description("An outer list of inner lists (inner list sorted by key) of asset and mark prices.")),
                    /** A list (sorted by key) of asset and external prices which prevent sudden mark price deviations. */
                    externalPerpPxs: v.pipe(v.array(v.tuple([
                        v.string(),
                        _schemas_js_1.UnsignedDecimal,
                    ])), v.description("A list (sorted by key) of asset and external prices which prevent sudden mark price deviations.")),
            ...
            v.object({
                ...
                setFundingMultipliers: v.pipe(v.array(v.tuple([
                    v.string(),
                    _schemas_js_1.UnsignedDecimal,
            ...
            v.object({
                ...
                setMarginTableIds: v.pipe(v.array(v.tuple([
                    v.string(),
            ...
            v.object({
                ...
                setFeeRecipient: v.pipe(v.object({
                    ...
                    feeRecipient: v.pipe(_schemas_js_1.Address, v.description("Address of the fee recipient.")),
            ...
            v.object({
                ...
                setOpenInterestCaps: v.pipe(v.array(v.tuple([
                    v.string(),
                    _schemas_js_1.UnsignedInteger,
            ...
            v.object({
                ...
                setSubDeployers: v.pipe(v.object({
                    ...
                    subDeployers: v.pipe(v.array(v.object({
                        ...
                        user: v.pipe(_schemas_js_1.Address, v.description("Sub-deployer address.")),
            ...
            v.object({
                ...
                setMarginModes: v.pipe(v.array(v.tuple([
                    v.string(),
            ...
            v.object({
                ...
                setFeeScale: v.pipe(v.object({
                    ...
                    scale: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Fee scale (between 0.0 and 3.0).")),
            ...
            v.object({
                ...
                setGrowthModes: v.pipe(v.array(v.tuple([
                    v.string(),
                    v.boolean(),

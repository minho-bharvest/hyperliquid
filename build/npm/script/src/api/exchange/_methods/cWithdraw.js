...
exports.CWithdrawTypes = exports.CWithdrawResponse = exports.CWithdrawRequest = void 0;
...
exports.CWithdrawRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            wei: v.pipe(_schemas_js_1.UnsignedInteger, v.minValue(1), v.description("Amount of wei to withdraw from staking balance (float * 1e8).")),

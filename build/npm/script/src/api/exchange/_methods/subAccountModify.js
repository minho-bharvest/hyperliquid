...
exports.SubAccountModifyResponse = exports.SubAccountModifyRequest = void 0;
...
exports.SubAccountModifyRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            subAccountUser: v.pipe(_schemas_js_1.Address, v.description("Sub-account address to modify.")),
...
exports.SubAccountModifyResponse = (() => {

...
exports.UsdSendTypes = exports.UsdSendResponse = exports.UsdSendRequest = void 0;
...
exports.UsdSendRequest = (() => {
    return v.pipe(v.object({
        ...
        action: v.pipe(v.object({
            ...
            /** Amount to send (1 = $1). */
            amount: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Amount to send (1 = $1).")),
            /** Nonce (timestamp in ms) used to prevent replay attacks. */
            time: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Nonce (timestamp in ms) used to prevent replay attacks.")),

...
exports.UserFillsByTimeResponse = exports.UserFillsByTimeRequest = void 0;
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#retrieve-a-users-fills-by-time
 */
exports.UserFillsByTimeResponse = (() => {
    return v.pipe(userFills_js_1.UserFillsResponse, v.description("Array of user trade fills by time."));
})();
/**
 * Request array of user fills by time.
 *
...
function userFillsByTime(config, params, signal) {
    const request = v.parse(exports.UserFillsByTimeRequest, {

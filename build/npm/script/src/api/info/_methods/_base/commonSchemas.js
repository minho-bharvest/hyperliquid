...
exports.OrderProcessingStatusSchema = exports.UserFillSchema = exports.ExplorerTransactionSchema = exports.VaultRelationshipSchema = exports.TwapStateSchema = exports.OpenOrderSchema = exports.FrontendOpenOrderSchema = exports.SpotAssetCtxSchema = exports.PerpAssetCtxSchema = void 0;
const v = __importStar(require("valibot"));
const _schemas_js_1 = require("../../../_schemas.js");
/** Perpetual asset context. */
exports.PerpAssetCtxSchema = (() => {
    return v.pipe(v.object({
        /** Previous day's closing price. */
        prevDayPx: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Previous day's closing price.")),
        /** Daily notional volume. */
        dayNtlVlm: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Daily notional volume.")),
        /** Mark price. */
        markPx: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Mark price.")),
        /** Mid price. */
        midPx: v.pipe(v.nullable(_schemas_js_1.UnsignedDecimal), v.description("Mid price.")),
        /** Funding rate. */
        funding: v.pipe(_schemas_js_1.Decimal, v.description("Funding rate.")),
        /** Total open interest. */
        openInterest: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Total open interest.")),
        /** Premium price. */
        premium: v.pipe(v.nullable(_schemas_js_1.Decimal), v.description("Premium price.")),
        /** Oracle price. */
        oraclePx: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Oracle price.")),
        ...
        dayBaseVlm: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Daily volume in base currency.")),
    }), v.description("Perpetual asset context."));
})();
/** Spot asset context. */
exports.SpotAssetCtxSchema = (() => {
    return v.pipe(v.object({
        /** Previous day's closing price. */
        prevDayPx: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Previous day's closing price.")),
        /** Daily notional volume. */
        ...
        midPx: v.pipe(v.nullable(_schemas_js_1.UnsignedDecimal), v.description("Mid price.")),
        /** Circulating supply. */
        circulatingSupply: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Circulating supply.")),
        /** Asset symbol. */
        coin: v.pipe(v.string(), v.description("Asset symbol.")),
        /** Total supply. */
        totalSupply: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Total supply.")),
        /** Daily volume in base currency. */
        dayBaseVlm: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Daily volume in base currency.")),
    }), v.description("Spot asset context."));
})();
/** Open order with additional display information. */
exports.FrontendOpenOrderSchema = (() => {
    return v.pipe(v.object({
        /** Asset symbol. */
        coin: v.pipe(v.string(), v.description("Asset symbol.")),
        ...
        /** Trigger price. */
        triggerPx: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Trigger price.")),
        /** Child orders associated with this order. */
        children: v.pipe(v.array(v.unknown()), v.description("Child orders associated with this order.")),
         ...
         */
        tif: v.pipe(v.nullable(v.picklist([
            "Gtc",
            "Ioc",
            "Alo",
            "FrontendMarket",
            ...
            '\n- `"LiquidationMarket"`: Similar to Ioc, used in Hyperliquid UI.')),
        /** Client Order ID. */
        cloid: v.pipe(v.nullable(_schemas_js_1.Cloid), v.description("Client Order ID.")),
    }), v.description("Open order with additional display information."));
})();
/** Open order. */
exports.OpenOrderSchema = (() => {
    return v.pipe(v.object({
        /** Asset symbol. */
        coin: v.pipe(v.string(), v.description("Asset symbol.")),
        /** Order side ("B" = Bid/Buy, "A" = Ask/Sell). */
...
/** TWAP order state. */
exports.TwapStateSchema = (() => {
    return v.pipe(v.object({
        /** Asset symbol. */
        coin: v.pipe(v.string(), v.description("Asset symbol.")),
        /** Executed notional value. */
        executedNtl: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Executed notional value.")),
        /** Executed size. */
        executedSz: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Executed size.")),
        /** Duration in minutes. */
        minutes: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Duration in minutes.")),
        ...
        side: v.pipe(v.picklist(["B", "A"]), v.description('Order side ("B" = Bid/Buy, "A" = Ask/Sell).')),
        /** Order size. */
        sz: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Order size.")),
        /** Start time of the TWAP order (in ms since epoch). */
        timestamp: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Start time of the TWAP order (in ms since epoch).")),
        /** User address. */
        user: v.pipe(_schemas_js_1.Address, v.description("User address.")),
    }), v.description("TWAP order state."));
})();
/** Vault relationship type. */
exports.VaultRelationshipSchema = (() => {
    return v.pipe(v.variant("type", [
        v.object({
            /** Relationship type. */
            type: v.pipe(v.picklist(["normal", "child"]), v.description("Relationship type.")),
        }),
        v.object({
            /** Relationship type. */
            ...
            data: v.pipe(v.object({
                ...
                childAddresses: v.pipe(v.array(_schemas_js_1.Address), v.description("Child vault addresses.")),
            }), v.description("Child vault information.")),
        }),
    ]), v.description("Vault relationship type."));
})();
/** Explorer transaction. */
exports.ExplorerTransactionSchema = (() => {
    return v.pipe(v.object({
        ...
        block: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Block number where transaction was included.")),
        ...
        time: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Transaction creation timestamp.")),
        /** Creator's address. */
        user: v.pipe(_schemas_js_1.Address, v.description("Creator's address.")),
    }), v.description("Explorer transaction."));
})();
/** User fill. */
exports.UserFillSchema = (() => {
    return v.pipe(v.object({
        /** Asset symbol. */
        coin: v.pipe(v.string(), v.description("Asset symbol.")),
        /** Price. */
 ...
 */
exports.OrderProcessingStatusSchema = (() => {
    return v.pipe(v.picklist([
        "open",
        "filled",
        "canceled",
        "triggered",

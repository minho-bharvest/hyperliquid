...
exports.UserVaultEquitiesResponse = (() => {
    return v.pipe(v.array(v.object({
        ...
        equity: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("User deposited equity.")),
        /** Timestamp when the user can withdraw their equity. */
        lockedUntilTimestamp: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Timestamp when the user can withdraw their equity.")),
...
function userVaultEquities(config, params, signal) {
    const request = v.parse(exports.UserVaultEquitiesRequest, {

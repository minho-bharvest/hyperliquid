...
exports.DelegationsResponse = exports.DelegationsRequest = void 0;
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#query-a-users-staking-delegations
 */
exports.DelegationsResponse = (() => {
    return v.pipe(v.array(v.object({
        /** Validator address. */
        validator: v.pipe(_schemas_js_1.Address, v.description("Validator address.")),
        /** Amount of tokens delegated to the validator. */
        amount: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Amount of tokens delegated to the validator.")),
        /** Locked until timestamp (in ms since epoch). */
        lockedUntilTimestamp: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Locked until timestamp (in ms since epoch).")),
...
function delegations(config, params, signal) {
    const request = v.parse(exports.DelegationsRequest, {
        type: "delegations",
        ...params,
    });

...
exports.UserTwapSliceFillsByTimeResponse = (() => {
    return v.pipe(userTwapSliceFills_js_1.UserTwapSliceFillsResponse, v.description("Array of user's twap slice fill by time."));
})();
/**
 * Request user TWAP slice fills by time.
 *
...
function userTwapSliceFillsByTime(config, params, signal) {
    const request = v.parse(exports.UserTwapSliceFillsByTimeRequest, {

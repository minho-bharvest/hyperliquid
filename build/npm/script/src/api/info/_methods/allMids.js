...
exports.AllMidsResponse = (() => {
    return v.pipe(v.record(v.string(), _schemas_js_1.UnsignedDecimal), v.description("Mapping of coin symbols to mid prices."));
})();
function allMids(config, paramsOrSignal, maybeSignal) {
    const params = paramsOrSignal instanceof AbortSignal ? {} : paramsOrSignal;
    const signal = paramsOrSignal instanceof AbortSignal ? paramsOrSignal : maybeSignal;
    const request = v.parse(exports.AllMidsRequest, {
        type: "allMids",
        ...params,
    });

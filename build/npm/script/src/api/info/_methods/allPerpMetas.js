...
exports.AllPerpMetasResponse = exports.AllPerpMetasRequest = void 0;
 ...
 */
exports.AllPerpMetasResponse = (() => {
    return v.pipe(v.array(meta_js_1.MetaResponse), v.description("Metadata for perpetual assets across all DEXes."));
})();
/**
 * Request trading metadata for all DEXes.
 *
 ...
 * ```
 */
function allPerpMetas(config, paramsOrSignal, maybeSignal) {
    const params = paramsOrSignal instanceof AbortSignal ? {} : paramsOrSignal;
    const signal = paramsOrSignal instanceof AbortSignal ? paramsOrSignal : maybeSignal;
    const request = v.parse(exports.AllPerpMetasRequest, {
        type: "allPerpMetas",
        ...params,
    });

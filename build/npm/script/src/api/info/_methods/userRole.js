    ...
    return v.pipe(v.variant("role", [
        ...
        v.object({
            ...
            data: v.pipe(v.object({
                ...
                user: v.pipe(_schemas_js_1.Address, v.description("Master account address associated with the agent.")),
        ...
        v.object({
            ...
            data: v.pipe(v.object({
                ...
                master: v.pipe(_schemas_js_1.Address, v.description("Master account address associated with the sub-account.")),
...
function userRole(config, params, signal) {
    const request = v.parse(exports.UserRoleRequest, {
        type: "userRole",
        ...params,
    });

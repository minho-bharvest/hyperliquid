...
exports.GossipRootIpsResponse = exports.GossipRootIpsRequest = void 0;
 ...
 * ```
 */
function gossipRootIps(config, paramsOrSignal, maybeSignal) {
    const params = paramsOrSignal instanceof AbortSignal ? {} : paramsOrSignal;
    const signal = paramsOrSignal instanceof AbortSignal ? paramsOrSignal : maybeSignal;
    const request = v.parse(exports.GossipRootIpsRequest, {
        type: "gossipRootIps",
        ...params,
    });

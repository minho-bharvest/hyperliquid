...
exports.FrontendOpenOrdersResponse = (() => {
    return v.pipe(v.array(commonSchemas_js_1.FrontendOpenOrderSchema), v.description("Array of open orders with additional display information."));
})();
/**
 * Request frontend open orders.
 *
...
function frontendOpenOrders(config, params, signal) {
    const request = v.parse(exports.FrontendOpenOrdersRequest, {

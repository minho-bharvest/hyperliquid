...
exports.PerpDexStatusResponse = exports.PerpDexStatusRequest = void 0;
...
exports.PerpDexStatusRequest = (() => {
    return v.pipe(v.object({
        /** Type of request. */
        type: v.pipe(v.literal("perpDexStatus"), v.description("Type of request.")),
        /** Perp dex name of builder-deployed dex market. The empty string represents the first perp dex. */
        dex: v.pipe(v.string(), v.description("Perp dex name of builder-deployed dex market. The empty string represents the first perp dex.")),
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint/perpetuals#get-perp-market-status
 */
exports.PerpDexStatusResponse = (() => {
    return v.pipe(v.object({
        /** Total net deposit. */
        totalNetDeposit: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Total net deposit.")),
...
function perpDexStatus(config, params, signal) {
    const request = v.parse(exports.PerpDexStatusRequest, {
        type: "perpDexStatus",
        ...params,
    });

...
exports.DelegatorSummaryResponse = (() => {
    return v.pipe(v.object({
        ...
        delegated: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Total amount of delegated tokens.")),
        /** Total amount of undelegated tokens. */
        undelegated: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Total amount of undelegated tokens.")),
        /** Total amount of tokens pending withdrawal. */
        totalPendingWithdrawal: v.pipe(_schemas_js_1.UnsignedDecimal, v.description("Total amount of tokens pending withdrawal.")),
        /** Number of pending withdrawals. */
        nPendingWithdrawals: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Number of pending withdrawals.")),
...
function delegatorSummary(config, params, signal) {
    const request = v.parse(exports.DelegatorSummaryRequest, {

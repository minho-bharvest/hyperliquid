...
exports.ActiveAssetCtxEvent = (() => {
    return v.pipe(v.object({
        ...
        ctx: v.pipe(commonSchemas_js_1.PerpAssetCtxSchema, v.description("Context for a specific perpetual asset.")),
...
function activeAssetCtx(config, params, listener) {
    const payload = v.parse(exports.ActiveAssetCtxRequest, { type: "activeAssetCtx", ...params });

...
exports.BboEvent = (() => {
    return v.pipe(v.object({
        ...
        time: v.pipe(_schemas_js_1.UnsignedInteger, v.description("Time of the BBO update (in ms since epoch).")),
...
function bbo(config, params, listener) {
    const payload = v.parse(exports.BboRequest, { type: "bbo", ...params });

...
const userNonFundingLedgerUpdates_js_1 = require("../../info/_methods/userNonFundingLedgerUpdates.js");
...
exports.UserNonFundingLedgerUpdatesEvent = (() => {
    return v.pipe(v.object({
        ...
        nonFundingLedgerUpdates: v.pipe(userNonFundingLedgerUpdates_js_1.UserNonFundingLedgerUpdatesResponse, v.description("Array of user's non-funding ledger update.")),
...
function userNonFundingLedgerUpdates(config, params, listener) {
    const payload = v.parse(exports.UserNonFundingLedgerUpdatesRequest, { type: "userNonFundingLedgerUpdates", ...params });

...
const historicalOrders_js_1 = require("../../info/_methods/historicalOrders.js");
...
exports.UserHistoricalOrdersEvent = (() => {
    return v.pipe(v.object({
        ...
        orderHistory: v.pipe(historicalOrders_js_1.HistoricalOrdersResponse, v.description("Array of frontend orders with current processing status.")),
...
function userHistoricalOrders(config, params, listener) {
    const payload = v.parse(exports.UserHistoricalOrdersRequest, { type: "userHistoricalOrders", ...params });

...
exports.ActiveAssetDataEvent = exports.ActiveAssetDataRequest = void 0;
...
const activeAssetData_js_1 = require("../../info/_methods/activeAssetData.js");
...
exports.ActiveAssetDataEvent = (() => {
    return v.pipe(activeAssetData_js_1.ActiveAssetDataResponse, v.description("Event of user active asset data."));
})();
/**
...
function activeAssetData(config, params, listener) {
    const payload = v.parse(exports.ActiveAssetDataRequest, { type: "activeAssetData", ...params });

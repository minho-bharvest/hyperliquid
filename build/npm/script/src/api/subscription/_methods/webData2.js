...
const webData2_js_1 = require("../../info/_methods/webData2.js");
...
exports.WebData2Event = (() => {
    return v.pipe(webData2_js_1.WebData2Response, v.description("Event of comprehensive user and market data."));
})();
/**
...
function webData2(config, params, listener) {
    const payload = v.parse(exports.WebData2Request, { type: "webData2", ...params });

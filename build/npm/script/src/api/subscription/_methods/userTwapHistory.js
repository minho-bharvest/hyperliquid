...
exports.UserTwapHistoryEvent = (() => {
    return v.pipe(v.object({
        ...
        history: v.pipe(twapHistory_js_1.TwapHistoryResponse, v.description("Array of user's TWAP history.")),
...
function userTwapHistory(config, params, listener) {
    const payload = v.parse(exports.UserTwapHistoryRequest, { type: "userTwapHistory", ...params });

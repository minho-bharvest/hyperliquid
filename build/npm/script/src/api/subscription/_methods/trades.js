...
// API Schemas
// ============================================================
const recentTrades_js_1 = require("../../info/_methods/recentTrades.js");
...
exports.TradesEvent = (() => {
    return v.pipe(recentTrades_js_1.RecentTradesResponse, v.description("Event of array of trades for a specific asset."));
})();
/**
...
function trades(config, params, listener) {
    const payload = v.parse(exports.TradesRequest, { type: "trades", ...params });

...
// API Schemas
// ============================================================
const allMids_js_1 = require("../../info/_methods/allMids.js");
...
exports.AllMidsEvent = (() => {
    return v.pipe(v.object({
        ...
        mids: v.pipe(allMids_js_1.AllMidsResponse, v.description("Mapping of coin symbols to mid prices.")),
        /** DEX name (empty string for main dex). */
        dex: v.pipe(v.optional(v.string()), v.description("DEX name (empty string for main dex).")),
...
function allMids(config, paramsOrListener, maybeListener) {
    ...
    const payload = v.parse(exports.AllMidsRequest, {
        type: "allMids",
        ...params,

...
export declare const ethHex: Coder<Bytes, string>;
export declare const ethHexNoLeadingZero: Coder<Bytes, string>;
...
export declare function sign(hash: Uint8Array, privKey: Uint8Array, extraEntropy?: boolean | Uint8Array): import("@noble/curves/abstract/weierstrass.js").ECDSASignature;
export type RawSig = {
    r: bigint;
    s: bigint;
};
export declare function verify(sig: Uint8Array, hash: Uint8Array, publicKey: Uint8Array): boolean;
export declare function initSig(sig: Uint8Array | RawSig, bit: number): import("@noble/curves/abstract/weierstrass.js").ECDSASignature & {

...
declare const accessListItem: P.Coder<(Bytes | Bytes[])[], {
    address: string;
    storageKeys: string[];
}>;
export type AccessList = CoderOutput<typeof accessListItem>[];
export declare const authorizationRequest: P.Coder<Bytes[], {
    chainId: bigint;
    address: string;
    nonce: bigint;
}>;
declare const authorizationItem: P.Coder<Bytes[], {
    chainId: bigint;
    address: string;
    nonce: bigint;
    yParity: number;
...
declare const coders: {
    ...
    to: P.Coder<Bytes, string>;
    value: P.Coder<P.Bytes, bigint>;
    data: P.Coder<Bytes, string>;
    accessList: P.Coder<(Bytes | Bytes[])[][], {
        address: string;
        storageKeys: string[];
    }[]>;
    ...
    authorizationList: P.Coder<Bytes[][], {
        chainId: bigint;
        address: string;
        nonce: bigint;
        yParity: number;

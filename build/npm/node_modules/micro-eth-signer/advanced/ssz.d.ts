...
export declare const ETH2_TYPES: {
    ...
    BeaconBlockBody: ContainerCoder<{
        ...
        blob_kzg_commitments: ListType<Bytes>;
    }>;
    ...
    BeaconState: ContainerCoder<{
        ...
        block_roots: VectorType<Bytes>;
        state_roots: VectorType<Bytes>;
        historical_roots: ListType<Bytes>;
        eth1_data: ContainerCoder<{
            deposit_root: ByteVectorType;
            deposit_count: SSZCoder<number | bigint>;
            block_hash: ByteVectorType;
        ...
        historical_summaries: ListType<{
            block_summary_root: Bytes;
            state_summary_root: Bytes;
        }>;
    }>;
    ...
    BlobSidecar: ContainerCoder<{
        ...
        kzg_commitment_inclusion_proof: VectorType<Bytes>;
    }>;
    ...
    LightClientHeader: ContainerCoder<{
        ...
        execution_branch: VectorType<Bytes>;
    }>;
    LightClientBootstrap: ContainerCoder<{
        ...
        current_sync_committee_branch: VectorType<Bytes>;
    }>;
    LightClientUpdate: ContainerCoder<{
        ...
        next_sync_committee_branch: VectorType<Bytes>;
        ...
        finality_branch: VectorType<Bytes>;
        sync_aggregate: ContainerCoder<{
            sync_committee_bits: BitVectorType;
            sync_committee_signature: ByteVectorType;
        }>;
...
export declare const ETH2_PROFILES: {
    electra: {
        ...
        ExecutionPayloadHeader: ProfileCoder<{
            ...
            withdrawal_requests_root: ByteVectorType;
            consolidation_requests_root: ByteVectorType;
        }, never, "timestamp" | "parent_hash" | "fee_recipient" | "state_root" | "receipts_root" | "logs_bloom" | "prev_randao" | "block_number" | "gas_limit" | "gas_used" | "extra_data" | "base_fee_per_gas" | "block_hash" | "blob_gas_used" | "excess_blob_gas" | "transactions_root" | "withdrawals_root">;
        ...
        }, never, "timestamp" | "parent_hash" | "fee_recipient" | "state_root" | "receipts_root" | "logs_bloom" | "prev_randao" | "block_number" | "gas_limit" | "gas_used" | "extra_data" | "base_fee_per_gas" | "block_hash" | "transactions" | "withdrawals" | "blob_gas_used" | "excess_blob_gas">;
